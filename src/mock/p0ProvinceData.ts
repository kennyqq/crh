...
export const provincePlaceLabels: Array<{
  ...
  { id: 'puyang', name: '濮阳', position: [115.03, 35.76] },
  { id: 'jiaozuo', name: '焦作', position: [113.24, 35.23] },
  { id: 'jiyuan', name: '济源', position: [112.60, 35.08] },
  ...
  { id: 'shangqiu', name: '商丘', position: [115.64, 34.41] },
  { id: 'luoyang', name: '洛阳', position: [112.44, 34.66] },
  { id: 'pingdingshan', name: '平顶山', position: [113.19, 33.77] },
  { id: 'zhoukou', name: '周口', position: [114.70, 33.62] },
  { id: 'nanyang', name: '南阳', position: [112.52, 33.00] },
  ...
  { id: 'sanmenxia', name: '三门峡', position: [111.20, 34.78] },
  { id: 'luozhou', name: '兰考', position: [114.82, 34.82] },
...
export const provinceStationLabels: Array<{
  ...
  { id: 'zhengzhou-west', name: '郑州西', position: [113.45, 34.79] },
  { id: 'xuchang-east', name: '许昌东', position: [113.85, 34.02] },
  { id: 'changge-north', name: '长葛北', position: [113.78, 34.23] },
  ...
  { id: 'shangqiu', name: '商丘', position: [115.62, 34.41] },
  { id: 'luoyang-longmen', name: '洛阳龙门', position: [112.46, 34.62] },
  { id: 'sanmenxia-south', name: '三门峡南', position: [111.18, 34.79] },
  ...
  { id: 'pingdingshan-west', name: '平顶山西', position: [113.21, 33.74] },
  { id: 'nanyang-east', name: '南阳东', position: [112.57, 32.99] },
  { id: 'zhoukou-east', name: '周口东', position: [114.68, 33.62] },
  ...
  { id: 'zhengzhou-airport', name: '新郑机场', position: [113.84, 34.56] },
]
